<template>
	<div class="configMain">
		<div style="text-align: center;line-height: 30px;font-weight: 600;" class="configTitle">送气侠</div>
		<div style="overflow-y:auto;height:calc( 100% - 80px );position: relative;">
			<el-tree draggable :default-checked-keys='defaultCheckedKey'  :default-expanded-keys="['1']"   :data="data" show-checkbox  node-key="id" ref="tree" highlight-current :props="defaultProps">
			</el-tree>
